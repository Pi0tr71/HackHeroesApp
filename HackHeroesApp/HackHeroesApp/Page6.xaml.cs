...
namespace HackHeroesApp
{
    ...
    public partial class Page6 : ContentPage
    {
        ...
        public Page6()
        {
            ...
            /// <summary>
            /// Oblicza maksymalne id pytania do którego może odwołać się użytkownik
            /// </summary>
            maxid = Values.instance.Level * 100;

            maxid = Values.instance.Level == 20 ? 2200 : 2000;
        }
        ...
        async void zapytanie()
        {
            ...
            /// <summary>
            /// Decyduje ile możliwych odpowiedzi ma się pokazać i w jakiej formie
            /// </summary>
